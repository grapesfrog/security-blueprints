...
1.  Prepare your namespace hierarchy under the ~/anthos-blueprints/config-root/namespaces folder.  For guidance refer to
...
9. Make a copy of the file Blueprints/enforcing-policies/enforce-label.yaml
